...
| Steam 视奸   |  *见插件主页* |  [nonebot-plugin-steam-game-status](https://github.com/nek0us/nonebot-plugin-steam-game-status)|
...
禁止将 bakabot 用于任何非法用途，本人有权在不通知的情况下从群聊移除 bakabot。
