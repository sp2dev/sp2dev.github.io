...
这些功能由 [NoneBot](https://nonebot.dev/) 及其插件 强力驱动

| 功能 | 调用指令示例 | 提供功能的插件 |
| :------ | :------- | :---------------------- |
| 群老婆 | 今日老婆 | [nonebot-plugin-today-waifu](https://github.com/glamorgan9826/nonebot-plugin-today-waifu) |
| Steam 视奸 | *详情见插件主页* | [nonebot-plugin-steam-game-status](https://github.com/nek0us/nonebot-plugin-steam-game-status) |
...
请勿将 bakabot 用于任何非法用途（但也没啥敏感的给你用说是），本人有权在不通知的情况下从群聊移除 bakabot。
